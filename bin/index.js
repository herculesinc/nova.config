...
let settings;
let logger;
let decryptor = defaultDecryptor;
// EXPORTED FUNCTIONS
// ================================================================================================
function getSettings() {
    ...
    try {
        ...
        if (fs.existsSync(secretsFile)) {
            ...
            if (!decryptor)
                throw Error('decryptor is undefined');
...
function configure(settings) {
    if (!settings)
        throw new TypeError('Configuration settings are undefined');
    // set logger
...
function defaultDecryptor(encrypted) {
